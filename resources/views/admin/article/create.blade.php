...
@section('content')
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-fw fa-newspaper-o"></i> Thêm mới tin tức <a href="{{route('admin.article.index')}}" type="button" class="btn btn-primary"><i class="fa fa-list"></i> Danh Sách</a>
        </h1>
    </section>
