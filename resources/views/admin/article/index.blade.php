            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header" style="padding: 15px 10px 5px 10px">
                        <h3 class="box-title" style="padding-top: 5px"><a href="{{ route('admin.article.index') }}" title="">Danh Sách Tin Tức</a></h3>
                            ...
                            @foreach($data as $key => $item)
                                <tr>
                                    ...
                                    @if ($item->image) <!-- Kiểm tra hình ảnh tồn tại -->
                                        <img src="{{asset($item->image)}}" width="100px" height="auto">
                                        @endif
                                    </td>
                                    <td>
                                        @if ($item->type === 1)
