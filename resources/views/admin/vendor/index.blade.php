            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header" style="padding: 15px 10px 5px 10px">
                        <h3 class="box-title" style="padding-top: 5px"><a href="{{ route('admin.vendor.index') }}" title="">Danh Sách Nhà Cung Cấp</a></h3>
                    ...
                    <div class="box-body">
                        <table class="table table-bordered">
                            ...
                            @if($data->count() == 0)
                                <tr>
                                    <td colspan="10" class="text-center text-danger" style="padding: 20px">Không tồn tại bản ghi nào phù hợp với kết quả tìm kiếm của bạn !!!</td>
                                </tr>
                            @endif
                        </table>
                    </div>
