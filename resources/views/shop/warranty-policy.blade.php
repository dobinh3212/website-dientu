...
<main>
    <section class="container stylization">
        ...
        <div class="tab-pane">
            ...
            <p><span style="font-size: small;">Khi mua sản phẩm tại Duc Sport, khách hàng có quyền hoàn toàn yên tâm với sản phẩm chính hãng, được bảo hành chính thức tại hãng và ngoài ra có thêm chính sách đổi mới miễn phí lên tới 30 ngày tại Duc Sport</span></p>
            ...
            <p><span id="docs-internal-guid-50932c38-7fff-3af3-c968-ffd847f1ca94" style="font-size: medium;"><strong><strong>II.Bảo hành tiêu chuẩn</strong></strong></span></p>
            <p><span style="text-decoration: underline;"><strong><span style="font-size: small;">1. Điện Thoại, LapTop:</span></strong></span></p>
            <p><span style="font-size: small;">Các sản phẩm chính hãng, Quý khách có thể tới các TTBH chính hãng hoặc trực tiếp tới các cửa hàng Duc Sport để được tiếp nhận gửi máy bảo hành chính hãng.</span></p>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr class="success">
                        ...
                        <th style="text-align: center;"><strong>Thời gian bảo hành</strong></th>
                        <th style="text-align: center;"><strong>Quyền lợi bảo hành</strong></th>
                        <th style="text-align: center;"><strong>Địa chỉ bảo hành</strong></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">12 tháng = Thời gian bảo hành còn lại tại hãng + Bảo hành tại Duc Sport</td>
                        <td style="text-align: left;">- Theo quyền lợi bảo hành của hãng trong thời gian được hãng bảo hành<br>- Sửa chữa, thay thế linh kiện trong thời gian bảo hành còn lại tại Duc Sport</td>
                        <td style="text-align: left;">TTBH chính hãng &amp; Duc Sport </td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: left;"> Duc Sport </td>
                    </tr>
                </tbody>
            </table>
            <ul style="list-style: none;">
            ...
            <table class="table table-bordered">
                <thead>
                    <tr class="success">
                        ...
                        <th style="text-align: center;"><strong>Quyền lợi bảo hành(lỗi từ phía nhà sản xuất)</strong></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td rowspan="9" style="text-align: center; vertical-align: middle;"> Duc Sport</td>
                    </tr>
                    <tr>
            ...
            <p><span style="font-size: small;">Việc kiểm tra và xác định lỗi do nhà sản xuất được thực hiện bởi Trung Tâm Bảo Hành – Đối tác sửa chữa các sản phẩm của Duc Sport hoặc Trung tâm bảo hành của nhà sản xuất.</span></p>
            ...
            <p><strong>4.2&nbsp;</strong>Sản phẩm đổi bảo hành (A) là sản phẩm giống với với sản phẩm Khách hàng mua ban đầu tại Duc Sport.</p>
            ...
            <p>-Với các trường hợp sản phẩm trong tình trạng không hoạt động, sản phẩm không thể kiểm tra, xác minh được số series, IMEI thì Duc Sport cần 05 – 07 ngày làm việc để gửi sản phẩm về hãng sản xuất để xác minh.</p>
            <p><strong>4.4&nbsp;</strong>Trường hợp Duc Sport có sản phẩm để đổi cho Khách hàng nhưng Khách hàng muốn đổi sang sản phẩm khác thì phải đổi sang sản phẩm có giá bán cao hơn sản phẩm hiện tại (A) và chịu phí 10% giá trị sản phẩm khi nhập lại:</p>
            ...
            <p><strong>4.5&nbsp;</strong>Trong trường hợp sản phẩm được đổi phát sinh lỗi tiếp (thuộc phạm vi bảo hành), Duc Sport&nbsp; vẫn sẽ bảo hành cho sản phẩm theo chế độ 1 đổi 1 trong thời gian bảo hành còn lại.</p>
            <p><strong>4.6&nbsp;</strong>Với các trường hợp không có sản phẩm để đổi ngay, Duc Sport cam kết thời gian xử lý đổi sản phẩm tối đa 07 ngày làm việc (trừ 7 + CN).&nbsp;Sau thời gian này, nếu không có sản phẩm đổi cho khách hàng, Duc Sport sẽ:</p>
            <p><strong>4.6.1&nbsp;</strong>Đổi cho khách hàng một sản phẩm khác cùng thương hiệu, dòng sản phẩm (ví dụ dòng Note Series, S Series với Samsung hoặc dòng Pro/Pro max với Apple) và có chất lượng tương đương với sản phẩm khách hàng mua ban đầu tại Duc Sport, hoặc</p>
            ...
            <p>Trường hợp nhập sản phẩm, khách hàng phải có hộp, phụ kiện. Nếu không đầy đủ hộp &amp; phụ kiện, Duc Sport trừ phí 5% giá trị của sản phẩm tại thời điểm bảo hành/món (hộp/phụ kiện)</p>
            ...
            <p>- Cơ sở xác định sản phẩm lỗi pin: Có giấy xác nhận lỗi pin từ Trung Tâm Bảo Hành hãng<strong><em> </em></strong>/ Hoặc kiểm tra tại Trung Tâm Bảo Hành – Đối tác sửa chữa các sản phẩm của Duc Sport, cơ sở xác định lỗi pin như sau:<strong><em> </em></strong>&nbsp;&nbsp;</p>
            <ul>
            ...
            <p>- Cơ sở xác định sản phẩm lỗi phím bấm vật lý: Thử kiểm tra nhấn phím bấm vật lý trong <strong>10 lần liên tiếp</strong> và phím bấm không hoạt động (không phản hồi).</p>
            <p><span id="docs-internal-guid-50932c38-7fff-3af3-c968-ffd847f1ca94" style="font-size: medium;"><strong><strong>IV.Bảo hành rơi vỡ, ngấm nước (BHRV - NN)</strong></strong></span></p>
            ...
            <p><span style="font-size: small;"><strong>4.2&nbsp;</strong>Trường hợp gặp các vấn đề <strong>hư hỏng do rơi vỡ, ngấm nước </strong>được Trung Tâm Bảo Hành – Đối tác sửa chữa các sản phẩm của Duc Sport - tiến hành <strong>sửa chữa/ thay thế linh kiện </strong>(hướng xử lý tùy theo mức độ từng trường hợp) cho khách hàng. Thời gian xử lý từ 07 – 14 ngày tùy thuộc vào mức độ hư hỏng của sản phẩm và tình trạng linh kiện.</span></p>
            <p><span style="font-size: small;"><strong>4.3&nbsp;</strong>Dịch vụ sửa chữa được thực hiện bởi Trung Tâm Bảo Hành – Đối tác sửa chữa các sản phẩm của Duc Sport với linh kiện thay thế được bảo hành theo thời hạn còn lại của gói dịch vụ bảo hành.</span></p>
            <p><span style="font-size: small;"><strong>4.4&nbsp;</strong>Với mỗi trường hợp xảy ra hư hỏng do rơi vỡ, ngấm nước</span></p>
            <p><span id="docs-internal-guid-50932c38-7fff-3af3-c968-ffd847f1ca94" style="font-size: medium;"><strong><strong>V.Bảo hành mở rộng S24+ (Bảo hành sản phẩm từ năm thứ 2)</strong></strong></span></p>
            ...
            <p><span style="font-size: small;"><strong>4.5&nbsp;</strong>Đối với các trường hợp không thể sửa chữa được, Duc Sport sẽ xử lý theo hướng:<strong></strong></span></p>
            ...
            <p><span style="font-size: small;"><strong>4.6&nbsp;</strong>Khách hàng có thể chuyển nhượng quyền sở hữu của sản phẩm và gói bảo hành mở rộng S24+ trong thời gian bảo hành.</span></p>
            <p><span id="docs-internal-guid-50932c38-7fff-3af3-c968-ffd847f1ca94" style="font-size: medium;"><strong><strong>VI. Lưu ý chung khi tiếp nhận sản phẩm bảo hành</strong></strong></span></p>
            ...
            <p>- Duc Sport bảo hành dựa vào số IMEI/SERIAL trên thân máy.</p>
            <p>- Các vấn về hình thức bên ngoài (ví dụ: tróc sơn, hở viền) sẽ không thuộc phạm vi bảo hành .</p>
            <p>- Địa điểm tiếp nhận bảo hành: Trung Tâm Bảo Hành – Đối tác sửa chữa các sản phẩm của Duc Sport.</p>
        </div>
        <!-- Warranty End-->
    </section>
</main>
